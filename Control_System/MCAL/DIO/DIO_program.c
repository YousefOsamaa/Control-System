...
/*DDRx array*/
static volatile u8_t* garr_ddrArray[NUMBER_OF_PORTS] = {MDIO_DDRB_ADDRESS, MDIO_DDRC_ADDRESS, MDIO_DDRD_ADDRESS};

/*PORTx array*/
static volatile u8_t* garr_portArray[NUMBER_OF_PORTS] = {MDIO_PORTB_ADDRESS, MDIO_PORTC_ADDRESS, MDIO_PORTD_ADDRESS};

/*PINx array*/
static volatile u8_t* garr_pinArray[NUMBER_OF_PORTS] = {MDIO_PINB_ADDRESS, MDIO_PINC_ADDRESS, MDIO_PIND_ADDRESS};
